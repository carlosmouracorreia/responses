...
class RequestsMock(object):
    ...
    def add(self, method, url, body='', match_querystring=False,
            ...
            content_type='text/plain', json=None, query_params=None, one_querystring_match=None):
        ...
        self._urls.append({
            ...
            'one_querystring_match' : one_querystring_match,
            'status': status,
    ...
    def _has_url_match(self, match, request_url):
        ...
        if _is_string(url):
            ...
            elif match['one_querystring_match']:
                url_without_qs = request_url.split('?', 1)[0]
                return url == url_without_qs and self._one_querystring_match(match['one_querystring_match'], request_url)
            else:
                url_without_qs = request_url.split('?', 1)[0]
